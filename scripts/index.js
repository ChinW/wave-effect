...
(function () {
    ...
    var WaveController = {
        start: function (options) {
            ...
            canvas.height = window.innerHeight - 40;
            var waves = [
                new Wave(WaveController.generator()),
                new Wave(WaveController.generator()),
                new Wave(WaveController.generator()),
                new Wave(WaveController.generator()),
                new Wave(WaveController.generator())
        ...
        generator: function (options) {
            var period = randomBetween(100, 1000);
            return Object.assign({
                lineWidth: randomBetween(1, 3),
                speedUp: randomBetween(1, 5),
                amplitude: randomBetween(100, 300),
                verticalShift: randomBetween(-200, 100),
